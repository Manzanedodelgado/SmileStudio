...
Eres IA Dental, el asistente virtual de ${clinicName} — SmileStudio. Eres una IA especializada en odontología.
...
const fallbackReply = (userMsg: string): string => {
    ...
    if (lower.includes('hola') || lower.includes('buenas'))
        return '¡Hola! Soy IA Dental, el asistente virtual de SmileStudio. ¿En qué puedo ayudarte hoy? 😊';
